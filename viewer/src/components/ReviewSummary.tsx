...
export function ReviewSummary() {
  ...
  const handleNavigate = (componentId: string) => {
    // Temporarily exit review mode behavior to navigate
                  ...
                  <div className={`px-3 py-2 border-b ${darkMode ? "border-zinc-800/50" : "border-zinc-100"}`}>
                    <div className="flex items-center justify-between">
                      ...
                      >
                        ...
                        <span className={`text-xs font-medium ${darkMode ? "text-zinc-200" : "text-zinc-800"}`}>
                          {comp.name}
                        </span>
                      ...
                      <div className="flex items-center gap-1">
                        <button
                          onClick={() => setAnnotatingComponent(annotation.componentId)}
