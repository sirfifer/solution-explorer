...
export function ReviewModeButton() {
  ...
  return (
    <div className="flex items-center gap-1">
      <Tooltip content="Review mode lets you annotate components, files, and symbols with feedback. When done, export all annotations as a structured prompt for AI-assisted code review." position="bottom">
        <button
      ...
      {count > 0 && reviewMode && (
        <Tooltip content="View all annotations and export as a prompt." position="bottom">
          <button
