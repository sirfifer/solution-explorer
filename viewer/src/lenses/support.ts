...
export const SUPPORT_QUESTIONS: LensQuestion[] = [
  {
    id: "attention",
    question: "What could make this fail in operation?",
    gesture: "Open a ranked component and inspect its observed reliance.",
  },
  {
    id: "configuration",
    question: "What must be configured?",
    gesture: "Inspect configuration keys and their owning components.",
  },
  {
    id: "external",
    question: "What is controlled outside this repository?",
    gesture: "Follow an external dependency to the component that uses it.",
  },
  {
    id: "entry",
    question: "Where would I start from a ticket?",
    gesture: "Open an entry point and continue to its evidence.",
  },
];
...
export const supportLens: LensDefinition = {
  id: "support",
  label: "Support",
  maturity: LENS_MATURITY.support,
